...
export function remarkImports() {
  return function transformer(tree /*: Root */) {
    ...
    try {
      ...
      visitImportContainers(tree, ({ node, group, env, title, frontmatter, filepath, provenance, children }) => {
        node.data = {
          hProperties: {
            containedCodeBlocks: [],
            "data-kui-import": "true",
