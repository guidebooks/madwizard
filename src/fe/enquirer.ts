...
declare class Enquirer extends EventEmitter {
  ...
  register(
    type: Record<
      string,
      Enquirer.Constructor<Enquirer.Prompt<any>> | (() => Enquirer.Constructor<Enquirer.Prompt<any>>)
    >
  ): this
  ...
  prompt(
    questions: Array<Enquirer.prompt.Question | ((this: Enquirer) => Enquirer.prompt.Question)>
  ...
  prompt(
    questions: Array<Enquirer.prompt.CustomQuestion | ((this: Enquirer) => Enquirer.prompt.CustomQuestion)>
  ): Promise<Enquirer.Answers>
...
declare namespace Enquirer {
  ...
  export function prompt(
    questions: Array<prompt.CustomQuestion | ((this: Enquirer) => prompt.CustomQuestion)>
  ): Promise<Answers>
